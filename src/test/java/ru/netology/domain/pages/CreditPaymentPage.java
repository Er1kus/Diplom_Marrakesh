...
public class CreditPaymentPage {
    private SelenideElement buyByCreditHeading = $(byText("Кредит по данным карты"));
    ...
    public CreditPaymentPage(){
        buyByCreditHeading.shouldBe(visible);
    }
    ...
    public void numberFieldError()  {cardNumberFieldError.shouldHave(text("Неверный формат"), Duration.ofSeconds(60));}
